//tealium universal tag - utag.374 ut4.0.201704181834, Copyright 2017 Tealium.com Inc. All Rights Reserved.
...
return s_vi_value;}},function(a,b){try{if(1){try{b['lr_cookie_id']=liveRampOmnitureId()}catch(e){}}}catch(e){utag.DB(e)}},function(a,b){try{if(1){(function(){var createCookie=function(name,value,days){var date=new Date();date.setTime(date.getTime()+(days*24*60*60*1000));document.cookie=name+"="+value+"; expires="+date.toUTCString()+"; path=/";};createCookie("liveramp_id",b.lr_cookie_id,730);})();}}catch(e){utag.DB(e)}}];u.send=function(a,b,c,d,e,f){if(u.ev[a]){for(c=0;c<u.extend.length;c++){try{d=u.extend[c](a,b);if(d==false)return}catch(e){}};for(c=0;c<u.p.length;c++){if(u.p[c]!=""){var x=u.rp(u.p[c],b);if(x!=""){if(u.cachebust=="enabled"&&x.indexOf("_rnd")<0){x+="&"+u.cachevar+"="+Math.random();}
...
return a;}
try{utag.o[loader].loader.LOAD(id)}catch(e){utag.loader.LOAD(id)}})('374','timeinc.fortune.com');}catch(error){utag.DB(error);}
