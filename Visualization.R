...
ggplot(fortune2015.df, aes(x = num_employees, y = ranking)) + geom_point()
...
ggplot(fortune2015.df, aes(x = assets, y = ranking)) + geom_point() 
...
# Profit Change -----------------------------------------------------------
ggplot(fortune2015.df, aes(x = profitchange, y = ranking)) + geom_point() 
